...
public class Triangle extends JFrame {
	 ...
	 JPanel contentPane;
		...
		Color myColor;
		int flag=0;
		int X=210,Y=150,W=200,H=130;
		
		int ch=0;
		int degree=0;
		int x;

		int X1=X+90,X2=X,X3=X+180;
		int Y1=Y,Y2=Y+150,Y3=Y+150;
		
		 JTextField textField;

		 
	public Triangle(Color c,int f) {
				...
				btnNewButton_1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						Color c=Color.blue;
						myColor=JColorChooser.showDialog(Triangle.this,"Select a Color", c);
			...
			public void paint(Graphics g)
			{
				...
				tri.moveTo(xary[0],yary[0]);
				
				tri.lineTo(xary[1],yary[1]);
				tri.lineTo(xary[2],yary[2]);
				tri.closePath();
				...
				switch(ch)
				{
					...
					case 20:
						...
						gg.rotate(Math.toRadians(degree),(X1+X2+X3)/3,(Y1+Y2+Y3)/3);

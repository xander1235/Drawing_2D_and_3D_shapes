	...
	public Circle(Color c,int f) {
				...
				btnNewButton_1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						Color c=Color.blue;
						myColor=JColorChooser.showDialog(Circle.this,"Select a Color", c);
			...
			public void paint(Graphics g)
			{
				...
				switch(ch)
				{
					...
					case 20:
						...
						gg.rotate(Math.toRadians(degree),X+W/2,Y+W);
